-- =========================================================
--  ВСЁ НОВОЕ ОДНИМ ФАЙЛОМ: задачи, карта, вишлист, лечение, деньги
--  Нужен только при установке с нуля. Если прошлые миграции уже
--  прогнаны — достаточно последнего файла из supabase/migrations.
-- =========================================================
